...
import deleteAdditionalCost from "@salesforce/apex/PricingServicesController.deleteItem";
...
export default class PricingServices extends LightningElement {
            ...
            if (eventData.fieldName === "costType") {
                ...
                try {
                    const quoteLineItem = await findPrices({
                        opportunityId: this.opportunity.Id, productId: item.productId, quantity: item.quantity
                    });
    ...
    async save(item) {
        ...
        try {
            ...
            item.dirty = false;
            await this.init();
            showToast(this, "Saved", "Services sales saved", "success");
        } catch (e) {
    ...
    async deleteItem(item) {
        ...
        try {
            if (item.recordId) {
                ...
                showToast(this, "Deleted", "Services sales deleted", "success");
            }
